...
//debuge( '$total_cost_of_booking', $total_cost_of_booking );
        ...
        $total_cost_of_booking['payment_cost']      =  number_format( $params['cost'], wpbc_get_cost_decimals() );		//FixIn: 8.2.1.24
        $total_cost_of_booking['payment_cost_hint'] =  wpbc_cost_show( $params['cost'], array(  'currency' => 'CURRENCY_SYMBOL' ) );

        $total_cost_of_booking['total_cost']        =  number_format( $params['cost'], wpbc_get_cost_decimals() );
        $total_cost_of_booking['total_cost_hint']   =  number_format( $total_cost_of_booking['payment_cost_hint'], wpbc_get_cost_decimals() );
        $total_cost_of_booking['deposit_cost']      =  number_format( $params['cost'], wpbc_get_cost_decimals() );
        $total_cost_of_booking['deposit_cost_hint'] =  number_format( $total_cost_of_booking['payment_cost_hint'], wpbc_get_cost_decimals() );
        ...
        $total_cost_of_booking['original_cost']     =  number_format( $params['cost'], wpbc_get_cost_decimals() );
        $total_cost_of_booking['original_cost_hint']=  number_format( $total_cost_of_booking['payment_cost_hint'], wpbc_get_cost_decimals() );
