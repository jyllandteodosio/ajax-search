    ...
    function wpbc_write_content_for_modal_export_csv( $filename, $bk_upload_dir ) {
      ...
      ?><div id="wpbc_export_csv_modal" class="modal wpbc_popup_modal" tabindex="-1" role="dialog">
        ...
        <script type="text/javascript"> 
            ...
            if ( jQuery.isFunction( jQuery('#wpbc_export_csv_modal').modal ) ) {
...
//debuge($_REQUEST);        
		...
		if ( ! empty($_REQUEST['wh_booking_type'])) {			//FixIn: 7.2.1.18	
			...
			if ( $_REQUEST['wh_booking_type'] == -999 ) { //FixIn: 7.2.1.18	// Trick, if -999, then we are set  the value to "" and we are show all bookings in old view mode for "Resource not exist"
