	...
	<ul id="category-list" class="sortable-list">
		...
		<li class="list-item new-item">
			...
			<div class="list-item-settings">
				...
				<label><?php _e('ID (unique)', 'mapplic'); ?><br><input type="text" class="input-text id-input" value=""></label>
				<label><input type="checkbox" class="expand-input" checked> <?php _e('Opened by default', 'mapplic'); ?></label>
	...
	<?php foreach ($data['categories'] as &$category) : ?>
		<li class="list-item">
			...
			<div class="list-item-settings">
				...
				<label><input type="checkbox" class="expand-input" <?php echo $shown; ?>> <?php _e('Opened by default', 'mapplic'); ?></label>
...
function mapplic_settings_box($post, $param) {
	...
	<input type="text" id="setting-height" value="<?php echo $data['height']; ?>" value="<?php echo $data['height']; ?>" placeholder="auto">
	<span>[mapplic id="<?php echo $post->ID; ?>" h="<span id="h-attribute"><?php echo ($data['height'] == '') ? 'auto' : $data['height']; ?></span>"]</span>
	...
	<label>
		<input type="checkbox" id="setting-smartip"<?php mplc_field($data['smartip'], 'true', ' checked', ''); ?>> <?php _e('Smart Tooltip', 'mapplic'); ?>
	</label>
	<label>
	...
	<label>
		<input type="checkbox" id="setting-thumbholder"<?php mplc_field($data['thumbholder'], 'true', ' checked', ''); ?>> <?php _e('Thumbnail Placeholder', 'mapplic'); ?>
	</label>
