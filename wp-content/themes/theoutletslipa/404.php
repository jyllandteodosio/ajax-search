...
add_action( 'genesis_before_content_sidebar_wrap', 'search_banner' );
function search_banner() {
      echo  '<section class="inner-banner">';
        echo  '<div class="wrap">';
         echo  '<h1 class="entry-title" itemprop="headline">Not found, error 404</h1>';
        echo  '</div>';
    echo  '</section>';
}
/**
